 ...
 * It contains a Map with pairs <Attribute,Predicate>.
 * 
...
public class FilterConfig
{
     ...
     * @param attribute that the predicate is associated to
     * @param predicate for the attribute
     */
     ...
     * @param attribute of the predicated
     */
