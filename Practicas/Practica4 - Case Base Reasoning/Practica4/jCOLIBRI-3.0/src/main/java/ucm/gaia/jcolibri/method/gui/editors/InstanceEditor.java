...
import ucm.gaia.jcolibri.exception.OntologyAccessException;
...
public class InstanceEditor extends JButton implements ParameterEditor {
	...
	private static Icon INSTANCE = new javax.swing.ImageIcon(FileIO.findFile("/es/ucm/fdi/gaia/ontobridge/test/gui/instance.gif"));
