...
public class DisplayCasesIfSimilarity
{
     ...
     */
    public static boolean displayCasesIfAllHaveMinimumSimilarity(List<RetrievalResult> retrieval, double minSimil)
    {
     ...
     */
    public static boolean displayCasesIfAnyHaveMinimumSimilarity(List<RetrievalResult> retrieval, double minSimil)
    {
	for(RetrievalResult rr: retrieval)
	    if(rr.getEval() >= minSimil)
		return true;
