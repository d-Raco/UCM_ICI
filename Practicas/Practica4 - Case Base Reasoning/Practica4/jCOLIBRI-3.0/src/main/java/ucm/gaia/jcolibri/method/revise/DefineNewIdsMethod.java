 ...
 * 07/01/2007
 */
package ucm.gaia.jcolibri.method.revise;
...
public class DefineNewIdsMethod {
	 ...
	 * This method traverses the CaseComponent tree of a case modifing the values of the ids attributes with new objects.
	 * @param _case to modify the ids 
	 * @param componentsKeys stores the new values of the IDs attributes
	 * @throws ExecutionException
	 */
	public static void defineNewIdsMethod(CBRCase _case, HashMap<Attribute, Object> componentsKeys) throws ExecutionException
	{
	...
	private static void defineNewIds(CaseComponent cc, HashMap<Attribute, Object> componentsKeys) throws ExecutionException
	{
		if(cc == null)
			return;
