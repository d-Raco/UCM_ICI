 ...
 * 11/01/2007
 */
package ucm.gaia.jcolibri.connector.databaseutils;
 ...
 * This is a Hibernate subclass that wraps any user defined data type. This way it can be persisted into
 * the data base easly.<p>
 * @author Juan A. Recio-Garc�a
 * @version 2.0
 * @see TypeAdaptor
 */
	...
	public void setParameterValues(Properties params) {
	    ...
	    for(Class c: clazz.getInterfaces())
	    	if (c.equals(TypeAdaptor.class))
	    		return;
	    throw new MappingException("Class "+ className + " does not implements jcolibri.connector.TypeAdaptor. " +
                "It is a requirement for using the genericUserType");
    }
