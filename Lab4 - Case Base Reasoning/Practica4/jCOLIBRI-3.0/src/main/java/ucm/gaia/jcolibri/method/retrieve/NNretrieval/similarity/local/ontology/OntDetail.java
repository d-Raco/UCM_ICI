...
/**
 * This function computes the detail similarity. See package documentation for
 * details.
 * 
 * @author Juan A. Recio-Garcia
 * @version 1.0
 */
public class OntDetail implements LocalSimilarityFunction
{
	...
	double res = 1 - (1 / (2 * intersectionsize));
	return res;
    }
