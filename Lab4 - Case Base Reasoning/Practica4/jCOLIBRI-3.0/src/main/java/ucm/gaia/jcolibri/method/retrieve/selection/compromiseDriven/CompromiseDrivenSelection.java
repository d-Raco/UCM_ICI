 ...
 * 21/11/2007
 */
package ucm.gaia.jcolibri.method.retrieve.selection.compromiseDriven;
...
public class CompromiseDrivenSelection
{
     ...
     */
    public static CDRSet CDR(CBRQuery query, List<RetrievalResult> cases, FilterConfig preferences)
    {
	...
	for(Attribute at : preferences.getDefinedAttributes())
	{
	    ...
	    {
		LogManager.getLogger(CompromiseDrivenSelection.class).error(e);
	    }
	}
