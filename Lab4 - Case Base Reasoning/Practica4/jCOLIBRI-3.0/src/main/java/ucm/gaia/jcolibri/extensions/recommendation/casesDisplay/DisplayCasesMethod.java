...
public class DisplayCasesMethod
{
     ...
     */
    public static UserChoice displayCases(List<CBRCase> cases)
    {
     ...
     * @return UserChoice object
     */
    public static UserChoice displayCasesWithEditOption(List<CBRCase> cases)
    {
     ...
     * @return UserChoice object.
     */
    public static UserChoice displayCases(List<CBRCase> cases, boolean editQueryEnabled)
    {
