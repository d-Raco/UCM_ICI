...
public class PearsonMatrixCaseBase extends MatrixCaseBase
{
    ...
    private HashMap<Integer,List<SimilarTuple>> similLists;
    
    @SuppressWarnings("unchecked")
    private void computeSimilarityLists()
    {
	similLists = new HashMap<Integer,List<SimilarTuple>>();
     ...
     */
    public List<SimilarTuple> getSimilar(Integer id)
    {
    ...
    {
	LogManager.getLogger().info("Computing similarities");
    ...
    {
	LogManager.getLogger().info("Computing Averages");
