...
public class DisplayCasesTableMethod
{
     ...
     */
    public static UserChoice displayCasesInTableBasic(List<CBRCase> cases)
    {
     ...
     * @return UserChoice object
     */
    public static UserChoice displayCasesInTableEditQuery(List<CBRCase> cases)
    {
     ...
     * @return UserChoice object
     */
    public static UserChoice displayCasesInTableSelectCase(List<CBRCase> cases)
    {
     ...
     * @return UserChoice object.
     */
    static UserChoice displayCasesInTable(List<CBRCase> cases, DisplayOption displayOption, String optionLabel)
    {
    ...
    {
	List<Attribute> atts = AttributeUtils.getAttributes(cc);
	if(atts == null)
	    return;
