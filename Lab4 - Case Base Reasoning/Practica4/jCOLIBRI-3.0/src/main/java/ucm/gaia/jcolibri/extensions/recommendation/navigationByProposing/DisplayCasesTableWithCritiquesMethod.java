...
import ucm.gaia.jcolibri.extensions.recommendation.casesDisplay.utils.RadioButtonEditor;
import ucm.gaia.jcolibri.extensions.recommendation.casesDisplay.utils.RadioButtonTableRenderer;
...
import ucm.gaia.jcolibri.method.retrieve.FilterBasedRetrieval.predicates.Equal;
 ...
 * @see ucm.gaia.jcolibri.extensions.recommendation.casesDisplay.DisplayCasesTableMethod
 */
public class DisplayCasesTableWithCritiquesMethod
{
    ...
    private static List<CBRCase> displayedCases;
    private static List<CritiqueOption> displayedCritiques;
    private static List<CBRCase> _availableCases;
    
    private static List<CritiqueOption> userCritiques;
     ...
     */
    public static CriticalUserChoice displayCasesInTableWithCritiques(List<CBRCase> cases, List<CritiqueOption> critiques, List<CBRCase> availableCases )
    {
