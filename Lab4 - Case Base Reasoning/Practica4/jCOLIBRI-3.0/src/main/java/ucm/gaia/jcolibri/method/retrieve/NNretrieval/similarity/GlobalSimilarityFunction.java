 ...
 * A global similarity function is applied to compound attributes by the NN algorithm.
...
public interface GlobalSimilarityFunction {
	 ...
	 * It requires the NNConfig object that stores the configuration of its contained attributes.
